...
public class AngleArmSubsystem extends SubsystemBase {
  ...
  public void setArmSpeedDynamic (double leftSpeed, double rightSpeed){
    angleArmMotorRight.set(AngleArmConstants.speedDampenerValue*(-rightSpeed));
    angleArmMotorLeft.set(AngleArmConstants.speedDampenerValue*(leftSpeed));
  }
